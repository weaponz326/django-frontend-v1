...
export class UserSearchComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log(sessionStorage.getItem('productionAdminSearchInput'));

    if(sessionStorage.getItem('productionAdminSearchInput')){
      this.searchQuery = sessionStorage.getItem('productionAdminSearchInput');
      this.doSearch();
    }
  }
  ...
  doSearch(){
    ...
    sessionStorage.setItem('productionAdminSearchInput', this.searchInput);
  ...
  getDetail(){
    this.adminApi.getDetail(String(sessionStorage.getItem('productionAdminSearchUser')))
      .subscribe(
        res => {
          console.log(res);
  ...
  sendInvitation() {
    let data = {
      account: localStorage.getItem('production_id'),
    ...
    this.adminApi.sendInvitation(data)
      .subscribe(
        res => {
          console.log(res);
          sessionStorage.setItem('production_invitation_id', res.data.id);
  ...
  gotoSearchDetail(userId: any){
    sessionStorage.setItem('productionAdminSearchUser', userId);
    this.getDetail();
  }
