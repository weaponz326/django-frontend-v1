...
export class AccessFormComponent implements OnInit {
  ...
  saveAccessLevel(){
    let access = {
      ...
      delveries_access: this.deliveriesCheckBox.value,
      menu_access: this.menuCheckBox.value,
      ordes_access: this.ordersCheckBox.value,
      true_access: this.paymentsCheckBox.value,
      portl_access: this.portalCheckBox.value,
