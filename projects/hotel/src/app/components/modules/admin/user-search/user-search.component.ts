...
export class UserSearchComponent implements OnInit {
  ...
  getDetail(){
    this.adminApi.getDetail(String(sessionStorage.getItem('hotelAdminSearchUser')))
      .subscribe(
        res => {
          console.log(res);
  ...
  sendInvitation() {
    let data = {
      account: localStorage.getItem('hotel_id'),
    ...
    this.adminApi.sendInvitation(data)
      .subscribe(
        res => {
          console.log(res);
          sessionStorage.setItem('hotel_invitation_id', res.data.id);
