...
export class PortalApiService {
  ...
  public getRinks(): Observable<any>{
    return this.http.get(this.hospitalUrl + "module-portal/rink-list?account=" + localStorage.getItem('hospital_id'));
  }
  ...
  public getSearch(input: string, filter: string): Observable<any>{
    ...
    return this.http.get(this.hospitalUrl + "accounts/search/?search=" + input);
  }

  // get search detail of selected account
  public getDetail(account: string): Observable<any>{
    return this.http.get(this.hospitalUrl + "accounts/search/" + account);
  }
  ...
  public getCountRinkDate(): Observable<any>{
    return this.http.get(this.hospitalUrl + "module-portal/count-rink-date/");
  }
