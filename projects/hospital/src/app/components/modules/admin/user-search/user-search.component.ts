...
export class UserSearchComponent implements OnInit {
  ...
  getDetail(){
    this.adminApi.getDetail(String(sessionStorage.getItem('hospitalAdminSearchUser')))
      .subscribe(
        res => {
          console.log(res);
  ...
  sendInvitation() {
    let data = {
      account: localStorage.getItem('hospital_id'),
    ...
    this.adminApi.sendInvitation(data)
      .subscribe(
        res => {
          console.log(res);
          sessionStorage.setItem('hospital_invitation_id', res.data.id);
